...
func answer(w http.ResponseWriter, r *http.Request) {
	...
	hub.Broadcast(GetHighscores())
	delete(activegames, t)
}

// Run starts the gameserver
func Run(h *wshub.WSHub) {
	hub = h
...
// GetHighscores returns the highscores as a jsonencoded bytearray
func GetHighscores() ([]byte, string) {
	...
	buffer.WriteString("]}")
	return buffer.Bytes(), "highscores"
}
